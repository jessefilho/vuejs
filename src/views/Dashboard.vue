<template>
  <div class="animated fadeIn">
    ...
    <b-row>
      ...
      <b-col cols="12" sm="6" lg="3">
        <chiffres-rebutca-total></chiffres-rebutca-total>
      </b-col>
      <b-col cols="12" sm="6" lg="3">
        <chiffres-rebutmarge-total></chiffres-rebutmarge-total>
      </b-col>
    </b-row>
    <b-row>
      <b-col sm="6" lg="3">
        <famille-sondes></famille-sondes>
      </b-col>
      <b-col sm="6" lg="3">
        <famille-acoustique></famille-acoustique>
      </b-col>
      <b-col sm="6" lg="3">
        <evolution-frabrication></evolution-frabrication>
      </b-col>
      <b-col sm="6" lg="3">
...
<script>
  ...
  import ChiffresdAffrairesTotal from "../components/chiffresglobalFinancier/ChiffresdAffrairesTotal";
  import ChiffresMargeTotal from "../components/chiffresglobalFinancier/ChiffresMargeTotal";
  import ChiffresRebutcaTotal from "../components/chiffresglobalFinancier/ChiffresRebutCATotal";
  import ChiffresRebutmargeTotal from "../components/chiffresglobalFinancier/ChiffresRebutMargeTotal";
  import FamilleSondes from "../components/chiffresProductionGlobal/FamilleSondes";
  ...
  export default {
    ...
    components: {
      ...
      FamilleAcoustique,
      FamilleSondes,
      ChiffresRebutmargeTotal,
      ChiffresRebutcaTotal,
      ChiffresMargeTotal,
      ChiffresdAffrairesTotal,
      Callout,
